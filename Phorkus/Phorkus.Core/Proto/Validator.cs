...
namespace Phorkus.Core.Proto {
  ...
  public static partial class ValidatorReflection {
    ...
    static ValidatorReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Cg92YWxpZGF0b3IucHJvdG8aDWRlZmF1bHQucHJvdG8iZQoJVmFsaWRhdG9y",
            "Eh4KCnB1YmxpY19rZXkYASABKAsyCi5QdWJsaWNLZXkSHgoFc3RhdGUYAiAB",
            "KA4yDy5WYWxpZGF0b3JTdGF0ZRIYCgV2b3RlcxgDIAEoCzIJLkZpeGVkMjU2",
            "KkkKDlZhbGlkYXRvclN0YXRlEhsKF1ZBTElEQVRPUl9TVEFURV9XQUlUSU5H",
            "EAASGgoWVkFMSURBVE9SX1NUQVRFX0FDVElWRRABQhWqAhJQaG9ya3VzLkNv",
  ...
  public sealed partial class Validator : pb::IMessage<Validator> {
    ...
    private global::Phorkus.Core.Proto.Fixed256 votes_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Phorkus.Core.Proto.Fixed256 Votes {
      get { return votes_; }
      set {
        votes_ = value;
      }
    ...
    public void MergeFrom(Validator other) {
      ...
      if (other.votes_ != null) {
        if (votes_ == null) {
          votes_ = new global::Phorkus.Core.Proto.Fixed256();
        }
