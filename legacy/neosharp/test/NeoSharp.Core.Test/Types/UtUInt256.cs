...
namespace NeoSharp.Core.Test.Types
{
    ...
    public class UtUInt256
    {
        ...
        public void Can_be_equal_to_another_number_of_same_type()
        {
            ...
            var b = UInt256.FromHex("0x4520462a8c80056291f871da523bff0eb17e29d44ab4317e69ff7a42083cb39d");
            (a == b).Should().BeTrue();
        }
        ...
        {
            var a = UInt256.FromHex("0x4520462a8c80056291f871da523bff0eb17e29d44ab4317e69ff7a42083cb39d");
            var b = UInt256.Zero;
            (a == b).Should().BeFalse();
        }
        ...
        public void Can_be_equal_to_another_number_of_object_type()
        {
            var a = new UInt256(new byte[]
                { 157, 179, 60, 8, 66, 122, 255, 105, 126, 49, 180, 74, 212, 41, 126, 177, 14, 255, 59, 82, 218, 113, 248, 145, 98, 5, 128, 140, 42, 70, 32, 69 });
            var b = (object)UInt256.FromHex("0x4520462a8c80056291f871da523bff0eb17e29d44ab4317e69ff7a42083cb39d");
        ...
        {
            var a = UInt256.FromHex("0x4520462a8c80056291f871da523bff0eb17e29d44ab4317e69ff7a42083cb39e");
            var b = UInt256.FromHex("0x4520462a8c80056291f871da523bff0eb17e29d44ab4317e69ff7a42083cb39d");
            (a > b).Should().BeTrue();
        }
        ...
        {
            var a = UInt256.FromHex("0x4520462a8c80056291f871da523bff0eb17e29d44ab4317e69ff7a42083cb39c");
            var b = UInt256.FromHex("0x4520462a8c80056291f871da523bff0eb17e29d44ab4317e69ff7a42083cb39d");
            (a < b).Should().BeTrue();
        }
        ...
        {
            var actual = UInt256.FromHex("0x4520462a8c80056291f871da523bff0eb17e29d44ab4317e69ff7a42083cb39d");
        ...
        {
            var actual = UInt256.TryParse("0x4520462a8c80056291f871da523bff0eb17e29d44ab4317e69ff7a42083cb39d", out var a);
        ...
        {
            var actual =  UInt256.TryParse("0x4520462a8c80056291f871da523bff0eb17e29d44ab4317e69ff7a42083cb39dx0", out var a);
