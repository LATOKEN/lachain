...
using NeoSharp.Persistence.RocksDB.Tests;
using NeoSharp.TestHelpers;
using NeoSharp.Types;

namespace NeoSharp.RocksDB.Tests
{
    [TestClass]
    public class UtRocksDbRepository : TestBase
    {
        ...
        */
        ...
        public async Task GetBlockHashFromHeight_HashFound_ReturnValidUInt256()
        {
            ...
            var expectedUint256 = UInt256.FromHex("0x4520462a8c80056291f871da523bff0eb17e29d44ab4317e69ff7a42083cb39d");
        ...
        public async Task AddBlockHeader_ValidBlockHeader_BlockHeaderAndHeightHashSaved()
        {
            ...
            var hash = UInt256.FromHex("0x4520462a8c80056291f871da523bff0eb17e29d44ab4317e69ff7a42083cb39d");
        ...
        {
            var input = UInt256.FromHex(RandomInt().ToString("X64"));
            var rocksDbContextMock = AutoMockContainer.GetMock<IRocksDbContext>();
            rocksDbContextMock
        ...
        {
            var inputHash = UInt256.FromHex(RandomInt().ToString("X64"));
        ...
        {
            var inputHash = UInt256.FromHex(RandomInt().ToString("X64"));
            var input = new Asset {Hash = inputHash};
            var expectedBytes = new byte[1];
            _serializerMock.Setup(m => m.Serialize(input, null)).Returns(expectedBytes);
            var rocksDbContextMock = AutoMockContainer.GetMock<IRocksDbContext>();
            var testee = AutoMockContainer.Create<RocksDbRepository>();
