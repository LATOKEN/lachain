...
namespace Phorkus.WebAssembly
{
	internal sealed class CompilationContext
	{
		...
		{
			Debug.Assert(exportsBuilder != null);
			...
			)
		{
			...
			Debug.Assert(signature.RawReturnTypes != null);
		...
		public MethodInfo this[HelperMethod helper]
		{
			get
			{
				Debug.Assert(this.helperMethods != null);
		...
		public MethodInfo this[HelperMethod helper, Func<HelperMethod, CompilationContext, MethodBuilder> creator]
		{
			get
			{
				...
				Debug.Assert(this.helperMethods != null);
				Debug.Assert(this.ExportsBuilder != null);

				if (this.helperMethods.TryGetValue(helper, out var builder))
					return builder;

				this.helperMethods.Add(helper, builder = creator(helper, this));
				Debug.Assert(builder != null, "Helper method creator returned null.");
				return builder;
			}
		}
