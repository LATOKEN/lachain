...
namespace Lachain.Core.Blockchain.SystemContracts.ContractManager
{
    public class ContractRegisterer : IContractRegisterer
    {
        ...
        public ContractRegisterer()
        {
            ...
            /* address <<0x4>> references PassiveStakingToken contract */
            RegisterContract<PassiveStakingTokenContract>(PassiveStakingTokenContract);
            /* address <<0x5>> references PassiveStaking contract */
            RegisterContract<PassiveStakingContract>(PassiveStakingContract);
        }
