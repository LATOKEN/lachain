...
namespace Phorkus.Proto {
  ...
  public sealed partial class BlockHeader : pb::IMessage<BlockHeader> {
    ...
    public BlockHeader(BlockHeader other) : this() {
      index_ = other.index_;
      PrevBlockHash = other.prevBlockHash_ != null ? other.PrevBlockHash.Clone() : null;
      MerkleRoot = other.merkleRoot_ != null ? other.MerkleRoot.Clone() : null;
      timestamp_ = other.timestamp_;
      StateHash = other.stateHash_ != null ? other.StateHash.Clone() : null;
  ...
  public sealed partial class Block : pb::IMessage<Block> {
    ...
    public Block(Block other) : this() {
      ...
      Multisig = other.multisig_ != null ? other.Multisig.Clone() : null;
