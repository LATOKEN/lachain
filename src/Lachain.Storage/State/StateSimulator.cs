...
namespace Lachain.Storage.State
{
    ...
    */
    public class StateSimulator : IStateManager
    {
        private static readonly ILogger<StateSimulator> Logger = LoggerFactory.GetLoggerForClass<StateSimulator>();
        ...
        public StateSimulator(IStorageManager storageManager)
        {
            _balanceManager =
                new SnapshotManager<IBalanceSnapshot, NoVerificationBalanceSnapshot>(storageManager,
        ...
        public void Commit()
        {
           throw new NotImplementedException("StateSimulator cannot commit to state");
        }
