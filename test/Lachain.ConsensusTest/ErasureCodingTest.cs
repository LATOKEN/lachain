...
namespace Lachain.ConsensusTest
{
    ...
    public class ErasureCodingTest
    {
        ...
        public void TestErasureCoding()
        {
            ...
            var rbc = new ReliableBroadcast(new ReliableBroadcastId(0, 0),
                new PublicConsensusKeySet(4, 1, null, null, Enumerable.Empty<ECDSAPublicKey>()), null!);
        ...
        //     _erasureCoding.EncodeInPlace(_plainText);
        ...
        //             }
        //
        //             Console.WriteLine("length {0} erasure {1} --- pass: {2} notpass: {3}", storeSize + cntErasure,
        //                 cntErasure, cntPass, cntNotPass);
        //         }
        //
        //         Console.WriteLine("");
        //     }
