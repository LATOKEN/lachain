...
namespace Phorkus.WebAssemblyTest.Instructions
{
    ...
    public class GetLocalTests
    {
        ...
        {
            var compiled = AssemblyBuilder.CreateInstance<ParameterTest>("Test", ValueType.Int32,
                new[] {ValueType.Int32},
                new GetLocal(0),
                new End()
            );
            ...
            var compiled2 = AssemblyBuilder.CreateInstance<ParameterTest2>("Test", ValueType.Int32,
                new[] {ValueType.Int32, ValueType.Int32},
                new GetLocal(1),
                new End()
            );
