...
namespace Phorkus.WebAssemblyTest.Instructions
{
    ...
    public class Int64RotateLeftTests
    {
        ...
        public void Int64RotateLeft_Compiled()
        {
            ...
            Assert.AreEqual(unchecked((long) 0xe000000dc000000f),
                exports.Test(unchecked((long) 0xfe000000dc000000), 4));
            ...
            Assert.AreEqual(unchecked((long) 0xcf013579ae529dea),
                exports.Test(unchecked((long) 0xabcd7294ef567809), unchecked((long) 0xffffffffffffffed)));
            Assert.AreEqual(0x55e891a77ab3c04e,
