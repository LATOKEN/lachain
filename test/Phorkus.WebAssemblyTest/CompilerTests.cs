...
namespace Phorkus.WebAssemblyTest
{
    ...
    public class CompilerTests
    {
        ...
        public void Compiler_MemoryImportExport()
        {
            ...
            var roundMemory = module.ToInstance<dynamic>(new[]
            {
                new MemoryImport("Memory", "Memory",
                    typeof(CompilerTests).GetMethod(nameof(GetMemoryFor_Compiler_MemoryImportExport)))
