...
namespace Phorkus.WebAssemblyTest
{
	...
	public class CompilerTests
	{
		...
		private static readonly UnmanagedMemory memory = new UnmanagedMemory(0, 1);

		/// <summary>
		/// Used by Compiler_MemoryImportExport to provide a memory instance.
		/// </summary>
		public static UnmanagedMemory GetMemoryFor_Compiler_MemoryImportExport() => memory;
		...
		public void Compiler_MemoryImportExport()
		{
			...
			var roundMemory = module.ToInstance<dynamic>(new[] { new MemoryImport("Memory", "Memory", typeof(CompilerTests).GetMethod(nameof(GetMemoryFor_Compiler_MemoryImportExport)))}).Exports.Memory as UnmanagedMemory;
