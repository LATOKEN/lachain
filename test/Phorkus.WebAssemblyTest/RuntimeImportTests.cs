...
namespace Phorkus.WebAssemblyTest
{
    ...
    using Type = WebAssembly.Type;
    using ValueType = WebAssembly.ValueType;
    ...
    public class RuntimeImportTests
    {
        ...
        public void Compile_RuntimeImportNoReturn()
        {
            ...
            var compiled = module.ToInstance<CompilerTestBaseVoid<double>>(
                new RuntimeImport[]
                {
                    new FunctionImport("Do", "Nothing",
                        typeof(NothingDoer).GetTypeInfo().GetMethod(nameof(NothingDoer.DoNothing)))
                });
        ...
        public void Compile_RuntimeImportMethodBuilderIsBlocked()
        {
            ...
            var x = Assert.ThrowsException<ArgumentException>(() =>
                new FunctionImport("TestModule", "TestExportName", methodBuilder));
