	...
	public class ModuleTests
	{
		...
		public void Module_ImportRoundTrip()
		{
			...
			Assert.IsInstanceOfType(imports[3], typeof(Import.Global));
			{
				...
				Assert.IsInstanceOfType(globalType.InitializerExpression[0], typeof(Int32Constant));
				Assert.AreEqual(4, ((Int32Constant)globalType.InitializerExpression[0]).Value);
				Assert.IsInstanceOfType(globalType.InitializerExpression[1], typeof(End));
