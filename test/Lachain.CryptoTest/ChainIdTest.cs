...
namespace Lachain.CryptoTest
{
    public class ChainIdTest
    {
        ...
        private static int _highestNewValidChainId = 32749; // to fit recId in 2 bytes
        private static int _highestOldValidChainId = 109; // to fit recId in 1 byte
        ...
        public void Test_SignatureWithMultipleChainId()
        {
            ...
            {
                chainIds.Add((GetRandomChainId(_lowestValidChainId, _highestOldValidChainId, rng),
                    GetRandomChainId(_lowestValidChainId, _highestNewValidChainId, rng)));
            }
        ...
        public int GetRandomChainId(int lowestChainId, int highestChainId, RNGCryptoServiceProvider rng)
        {
            var range = highestChainId - lowestChainId + 1;
            return GetRandomByteInRange(range, rng) + lowestChainId;
        }
